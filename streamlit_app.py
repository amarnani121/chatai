...
behaviors = [
    ...
    "Teaching Expert 📚",
    "Jarvis 🤖",
    "AI Therapist 🛋️",  # Added back
    "Custom Behavior 🛠️"  # Added back
]
...
with st.sidebar:
    ...
    if behavior_option == "Custom Behavior 🛠️":
        st.session_state.custom_behavior = st.text_area(
            "Create Custom Behavior:",
            value=st.session_state.custom_behavior,
            height=150,
            placeholder="Define your custom AI personality...",
            help="Example: 'You are a pirate captain. Speak in pirate slang and give sailing advice.'"
        )
